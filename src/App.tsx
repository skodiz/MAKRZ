...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .tag { padding: 0px 8px; min-height: 20px; align-items: center; justify-content: center; background: transparent; border: 1px solid #D8CCBD; color: #6B645C; border-radius: 999px;; font-size: 10px; font-weight: 500; }
